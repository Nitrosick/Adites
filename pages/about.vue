...
const persons = [
  { id: 1, photo: 'esau.jpeg', name: 'Dieter Esau', position: {
    ...
    hr: 'Upravljački partner u prodaji<br>marketingu i organizaciji'
  } },
  { id: 2, photo: 'erlich.jpeg', name: 'Alexei Erlich', position: {
    ...
    hr: 'Upravljački partner<br>Tehnički voditelj za pripremu i kontrolu rada'
  } },
  { id: 3, photo: null, name: 'Artur Braun', position: {
    ...
    hr: 'Voditelj prodaje<br>Računovodstva, nabave i kontrole'
  } }
]
...
const translates = {
  en: {
    ...
    historyTitle: 'The company history of ADITES d.o.o.',
    ...
    history: [
      ...
      'At the end of 2014, we as Erlich&Esau GbR were able to acquire land for a construction project. At the same time, financing for a plus-energy settlement was approved. In February 2015 everything was ready to start the construction project, but then Erlich&Esau GbR received a lucrative offer:<br><br> The entire construction project is financed and redesigned and Erlich&Esau GbR can realize the idea of ​​building a plus-energy settlement relatively risk-free. All energy and electrical planning is carried out for the current project.<br><br>The company ADITES d.o.o. was founded in May 2015. The name comes from the Indian sun god Aditya. The purpose of the company remained the same as that of the company Erlich&Esau GbR, which was wound up in the same year.<br><br>Today, our young and successful entrepreneur is in a strong technological competitive position for the business areas of the future such as renewable energies and decentralized energy supply. Economy, ecology and social responsibility are at the forefront, especially in the areas of energy and building management.'
    ]
  },
  de: {
    title: 'Über Uns',
    subtitle: 'ADITES – Ein team für ihre energiefreiheit!',
    historyTitle: 'Die Firmengeschichte der ADITES d.o.o.',
    ...
    history: [
      ...
      'Ende 2014 konnten wir als Erlich&Esau GbR ein  Grundstück für ein Bauprojekt erwerben. Parallel dazu wurde die Finanzierung für eine  Plus-Energie-Siedlung genehmigt. Im Februar 2015 war alles soweit, um das Bauvorhaben zu starten, doch dann bekam Erlich&Esau GbR ein lukratives Angebot:<br><br>Das gesamte Bauvorhaben wird finanziert und umgestaltet und Erlich&Esau GbR kann relativ risikofrei die Idee, Bau einer Plus-Energie-Siedlung, zu verwirklichen. Die gesamte energetische und elektrische Planung wird für das aktuelle Projekt übernommen.<br><br>Im Mai 2015 wird das Unternehmen ADITES d.o.o. gegründet. Die Namensgebung entspringt dem indischen Sonnengott Aditya. Der Unternehmenszweck blieb der gleiche wie auch bei der Unternehmung Erlich&Esau GbR, die im gleichen Jahr abgewickelt wurde.<br><br>Heute befindet sich unseres junges und erfolgreiches  Unternehmer in einer starken  technologischen Wettbewerbsposition für die Geschäftsfelder der Zukunft wie etwa die regenerativen Energien und die dezentrale Energieversorgung. Ökonomie, Ökologie und gesellschaftliche Verantwortung steht im Vordergrund, besonders in den Bereichen Energie- und Gebäudemanagement.'
    ]
  },
  hr: {
    title: 'O Nama',
    subtitle: 'ADITES – Tim za vašu energetsku slobodu!',
    historyTitle: 'Povijest tvrtke ADITES d.o.o.',
    historySubtitle: '...kako je sve počelo!',
    history: [
      'Povijest tvrtke počinje 2011.godine, kada je Dieter Isau osnovao svoje samostalno poduzeće u području energetskog savjetovanja. Fokus savjetovanja bio je na području električne energije i obnovljivih izvora energije, posebno fotonaponskih. Još 2012.godine Dieter Isau savjetovao je i obučavao velike tvrtke poput AIK-a o tehničkim i pravnim pitanjima.<br><br>2014.godine Aleksej Ehrlich pridružio se poslu. Njegova je ideja bila izgraditi kuće s povećanom energijom na solarni pogon. Tada je osnovana tvrtka za razvoj nekretnina u obliku MK, koja se također bavi električnim i fotonaponskim sustavima i obavlja internetsku trgovinu.<br><br>',
      'Krajem 2014.godine, mi smo, kao A&A, mogli kupiti zemljište za provedbu građevinskog projekta. Istodobno je odobreno financiranje projekta "Plus-energija". U veljači 2015.sve je bilo spremno za početak gradnje, ali tada je tvrtka Ame&Ame dobila povoljnu ponudu:<br><br>Cijeli građevinski projekt financiran je i redizajniran, a Ame&Ame može realizirati ideju izgradnje naselja s pozitivnom energijom relativno bez rizika. Sve energetsko i električno planiranje provodi se za tekući projekt.<br><br>Tvrtka M. A. osnovana je u svibnju 2015. Ovo ime potječe od imena indijskog boga Sunca Aditije. Cilj tvrtke ostao je isti kao i tvrtka M&M koja je osnovana iste godine.<br><br>Danas naš mladi i uspješni poduzetnik zauzima snažnu tehnološku konkurentsku poziciju u budućim poslovnim područjima kao što su obnovljivi izvori energije i decentralizirana opskrba energijom. Gospodarstvo, ekologija i društvena odgovornost su u prvom planu, posebno u energetici i upravljanju zgradama.'
    ]
  }
}
